 ...
 */
package com.example.voip.voip.core.service
...
@MainThread
class CoreKeepAliveThirdPartyAccountsService(
    private val iCondoLinphoneImpl: ICondoLinphoneImpl
) : Service() {
    companion object {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        iCondoLinphoneImpl.startKeepAliveService()
        return START_STICKY
    }
